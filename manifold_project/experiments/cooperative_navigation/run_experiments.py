...
#  python manifold\manifold_project\experiments\cooperative_navigation\run_experiments.py --profile pilot --seeds 40 --experiments N-C N-A --plot --budget 10000000  --device cuda
def parser():
